    ...
    <div className='div1' id='div1'>
      ...
      <div className='divRight'>
        ...
        <p>Mina avslutade utbildningar innehåller min breda examen från Teknikhögskolan med titeln "Pythonutvecklare inriktning AI". Samt min gymnasieexamen inom ekonomi.
          <span className='readMoreLink' onClick={() => scrollToSection('div2')}>
            Läs mer här
          </span>
         </p>
        <p>Min framtid är obestämd, vilket jag ser positivt på. Jag är hoppfullt emot vad som mig väntar! Kanske har du nästa spännande möjlighet för mig? Hör gärna av dig via mina kontaktkanaler som du hittar i menyn ovan.</p>
      </div>
    </div>
  );
};
